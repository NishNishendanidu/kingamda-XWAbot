...
module.exports = {
    ...
    AFNN: process.env.TAG_REPLY === undefined ? '94772830@s.whatsapp.net' : process.env.TAG_REPLY,
    NBSK: process.env.ALL_NUMBER === undefined ? '94772830' : process.env.ALL_NUMBER,
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? "kingamda-X¹;kingamda-X ;https://i.ibb.co/9VNNSFF/Kingamda-X-logo.jpg' : process.env.AUDIO_DATA,
    BLOCKCHAT: process.env.BLOCK_CHAT === undefined ? false : process.env.BLOCK_CHAT,
    ADDMSG: process.env.ADD_MESSAGE === undefined ? 'default' : process.env.ADD_MESSAGE,
    MUTEMSG: process.env.MUTE_MESSAGE === undefined ? 'default' : process.env.MUTE_MESSAGE,
    PLK: process.env.OWNER_NAME === undefined ? 'nishen¹¹' : process.env.OWNER_NAME,
    ...
    SUPPORT: process.env.ASENA === undefined ? '772733-632266,425552' : process.env.ASENA,
    ...
    SKDL: process.env.DIALOGUE === undefined ? '*kingamda-X whatsApp user bot*' : process.env.DIALOGUE,
    BLOCKMSG: process.env.BLOCK_MESSAGE === undefined ? 'default' : process.env.BLOCK_MESSAGE,
    UNBLOCKMSG: process.env.UNBLOCK_MESSAGE === undefined ? 'default' : process.env.UNBLOCK_MESSAGE,
    SOURAV: process.env.SK_BLOCK === undefined ? 'false' : process.env.SK_BLOCK,
    SOURAVKL11: process.env.STICKER_DATA === undefined ? 'kingamda-X¹¹|kingamda-X' : process.env.STICKER_DATA,
    ...
    sourav_g_link: process.env.GROUP_LINK === undefined ? 'https://chat.whatsapp.com/IenzfL0NJEp2kNVkJfVGU8' : process.env.GROUP_LINK,
    BRANCH: 'master',
    HEROKU: {
    ...
    SUPPORT2: "https://chat.whatsapp.com/IenzfL0NJEp2kNVkJfVGU8",
    SUPPORT3: "https://chat.whatsapp.com/IenzfL0NJEp2kNVkJfVGU8"
};
